...
if __name__ == "__main__": 
	...
	gui.title("CODE CLAUSE PROJECT 2") 
	...
	multiply = Button(gui, text=' * ', fg='white', bg='gray',command=lambda: press("*"), height=1, width=7) 
	multiply.grid(row=4, column=3) 

	divide = Button(gui, text=' / ', fg='white', bg='gray',command=lambda: press("/"), height=1, width=7) 
	divide.grid(row=5, column=3) 

	equal = Button(gui, text=' = ', fg='white', bg='gray',command=equalpress, height=1, width=7) 
	equal.grid(row=5, column=2) 

	clear = Button(gui, text='Clear', fg='white', bg='gray',command=clear, height=1, width=7) 
	clear.grid(row=5, column='1') 

	Decimal= Button(gui, text='.', fg='white', bg='gray',command=lambda: press('.'), height=1, width=7) 
